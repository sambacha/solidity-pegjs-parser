...
function peg$parse(input, options) {
  ...
  var peg$f10 = function () {
    return {
      type: 'Literal',
      value: parseFloat(text().replaceAll('_', '')),
      start: location().start.offset,
      end: location().end.offset,
    };
  };
  ...
  var peg$f32 = function (operator, major, minor, patch) {
    ...
    return {
      ...
      operator: operator,
      version:
        normalizeVersionLiteral(major) +
        '.' +
        normalizeVersionLiteral(minor) +
        '.' +
        normalizeVersionLiteral(patch),
      start: location().start.offset,
      end: location().end.offset,
    };
  };
  ...
  var peg$f58 = function (literal, members, parts) {
    return {
      ...
      members: optionalList(members).map(function (m) {
        return m[1].name;
      }),
      array_parts: optionalList(parts).map(function (p) {
        return p[3] != null ? p[3].value : null;
      }),
      start: location().start.offset,
      end: location().end.offset,
    };
    ...
    return {
      ...
      isconstant: constant
        ? constant[0] === 'constant'
          ...
          : false
        : false,
      isimmutable: constant
        ? constant[0] === 'immutable'
          ? true
          : false
        : false,
  ...
  var peg$f87 = function (head, tail) {
    ...
    var expressions = buildList(head, tail, 3),
      finalExpr = [];

    for (var i = 0; i < expressions.length; i++) {
      if (expressions[i] !== null) {
        finalExpr.push(expressions[i]);
      }
    }
  ...
  var peg$f100 = function (expression) {
    return expression;
  };
  ...
  var peg$f106 = function (param, body) {
    return {
      type: 'CatchClause',
      param: param,
      body: body,
  ...
  var peg$f109 = function (test, consequent, alternate) {
    return {
      type: 'IfStatement',
      test: test,
      consequent: consequent,
  ...
  var peg$f110 = function (test, consequent) {
    return {
      type: 'IfStatement',
      test: test,
      consequent: consequent,
  ...
  var peg$f111 = function (start_version, end_version) {
    return {
  ...
  var peg$f112 = function (featureName) {
    return {
  ...
  var peg$f114 = function (from, alias) {
    return {
  ...
  var peg$f115 = function (symbol, from) {
    return {
      type: 'ImportStatement',
      from: from.value,
      symbols: [symbol],
  ...
  var peg$f116 = function (symbols, from) {
    return {
      type: 'ImportStatement',
      from: from.value,
      symbols: symbols,
  ...
  var peg$f117 = function (library, type) {
    return {
      type: 'UsingStatement',
  ...
  var peg$f119 = function (callexpr) {
    return {
      type: 'EmitStatement',
      expression: callexpr,
      start: location().start.offset,
  ...
  var peg$f122 = function (name, alias) {
    return {
      type: 'Symbol',
      name: name.name,
  ...
  var peg$f124 = function (body, test) {
    return {
  ...
  var peg$f125 = function (test, body) {
    return {
      type: 'WhileStatement',
      test: test,
      body: body,
  ...
  var peg$f126 = function (init, test, update, body) {
    return {
      type: 'ForStatement',
  ...
  var peg$f127 = function (declarations, test, update, body) {
    return {
      type: 'ForStatement',
      init: {
        type: 'VariableDeclaration',
  ...
  var peg$f135 = function (argument) {
    return {
      type: 'ReturnStatement',
      argument: argument,
      start: location().start.offset,
  ...
  var peg$f137 = function (abstract, id, is, body) {
    return {
  ...
  var peg$f138 = function (id, is, body) {
    return {
  ...
  var peg$f140 = function (modifiers) {
    return {
      type: 'IsStatement',
      names: modifiers,
      start: location().start.offset,
  ...
  var peg$f141 = function (fnname, isanonymous) {
    return {
  ...
  var peg$f143 = function (fnname, names, body) {
    return {
  ...
  var peg$f144 = function (fnname, args, returns, body) {
    return {
  ...
  var peg$f145 = function (fnname, args, returns) {
    return {
      type: 'FunctionDeclaration',
      name: fnname.name,
      params: fnname.params,
  ...
  var peg$f146 = function (fnname, args, body) {
    return {
  ...
  var peg$f149 = function (params) {
    return params != null ? params[2] : null;
  };
  var peg$f150 = function (returnParams) {
  ...
  var peg$f151 = function (id, params) {
    return {
      type: 'FunctionName',
  ...
  var peg$f158 = function (alias, modifier) {
    if (alias.length > 0) {
  ...
  var peg$f160 = function (type, isindexed, isconstant, storage, id) {
    return {
  ...
  var peg$f163 = function (id, head, tail) {
    return {
      type: 'EnumDeclaration',
      name: id.name,
      members: buildList(head, tail, 3).map(function (i) {
        return i.name;
      }),
      start: location().start.offset,
      end: location().end.offset,
  ...
  var peg$f171 = function (id, params, returns, body) {
    return {
  ...
  var peg$f172 = function (names, expression) {
    if (expression != null) {
  ...
  var peg$f175 = function (name, head, tail) {
    return {
  ...
  var peg$f177 = function (test, body) {
    return {
      type: 'AssemblyIf',
      test: test,
      body: body,
  ...
  var peg$f178 = function (init, test, update, body) {
    return {
      type: 'AssemblyFor',
      init: init,
      test: test,
